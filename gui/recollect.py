...
_RECOLLECTIONS_PATH = None

def initialize(recollections_dir_path):
    global _RECOLLECTIONS_PATH
    _RECOLLECTIONS_PATH = os.path.join(recollections_dir_path, "guistate.mem")
    load_recollections()
